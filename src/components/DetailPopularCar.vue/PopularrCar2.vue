<template>
    <div class="car-container">
      ...
      <div class="car-article">
        <h2>{{ carName }}</h2>
        <p>
          {{ carDescription }} เป็นรถกระบะยอดนิยมในประเทศไทย ที่ได้รับการยอมรับในด้านความทนทาน
          สมรรถนะที่แข็งแกร่ง และความน่าเชื่อถือ เหมาะสำหรับการใช้งานทั้งในชีวิตประจำวันและการบรรทุกหนัก
        </p>
        <p>
          {{ carName }} มีเครื่องยนต์ดีเซลให้เลือกหลากหลายขนาด พร้อมระบบขับเคลื่อน 2 ล้อ และ 4 ล้อ
          ตอบโจทย์ทุกความต้องการในการใช้งาน ไม่ว่าจะขับขี่ในเมือง หรือลุยในเส้นทางที่ท้าทาย
        </p>
        <p>
          ...
          <table class="special-table">
            <tbody>
              <tr>
                ...
                <td>ขับเคลื่อนสี่ล้อ (4WD)</td>
              </tr>
              <tr>
                <td>เครื่องยนต์:</td>
                <td>3.0 ลิตร ดีดีไอ บลูเพาเวอร์</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>ระบบเกียร์:</td>
                <td>อัตโนมัติ 6 สปีด</td>
              </tr>
              <tr>
                <td>ขนาด (ยาว x กว้าง x สูง):</td>
                <td>5,265 x 1,870 x 1,790 มม.</td>
              </tr>
              <tr>
        ...
        <p class="disclaimer">
          คำแนะนำการใช้ข้อมูล: ข้อมูลที่แสดงเป็นข้อมูลเบื้องต้นสำหรับรุ่น Double Cab 4x4 V-Cross
          สเปคและราคาอาจแตกต่างกันไปในแต่ละรุ่นย่อย โปรดสอบถามรายละเอียดเพิ่มเติมจากผู้จำหน่าย Isuzu อย่างเป็นทางการ
        </p>
      </div>
    </div>
  </template>
    ...
    data() {
      return {
        ...
        carImages: [
          ...
          "https://performancedrive.com.au/wp-content/uploads/2020/10/2021-Isuzu-D-Max-LS-U-back-seats.jpg",
          "https://performancedrive.com.au/wp-content/uploads/2020/10/2021-Isuzu-D-Max-LS-U-engine-1280x774.jpg",
          "https://performancedrive.com.au/wp-content/uploads/2020/10/2021-Isuzu-D-Max-LS-U-handling-1280x780.jpg"
        ],
        currentImage: 0
      };
    },
